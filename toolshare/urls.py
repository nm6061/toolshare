...
urlpatterns = patterns('',
    ...
    url(r'^reservation/(?P<reservation_id>\d+)/init_return/$', 'app.views.initiate_return', name = 'initiate_return'),
    url(r'^reservation/(?P<reservation_id>\d+)/ack_return/$', 'app.views.acknowledge_return', name = 'acknowledge_return'),
